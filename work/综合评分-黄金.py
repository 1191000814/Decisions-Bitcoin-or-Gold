...
df1 = pd.read_csv("../data/LSTM-黄金.csv")
df2 = pd.read_csv("../data/灰色涨幅-黄金.csv", delimiter = ',')
lstm_grade = np.array(df1.values[:, 0], dtype = float) # 序列: 所有的0,1串
days = len(lstm_grade)
...
ic(len(overall_grade))
np.savetxt("../data/综合指标-黄金.csv", overall_grade)